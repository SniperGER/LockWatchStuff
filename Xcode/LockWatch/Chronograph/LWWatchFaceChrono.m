...
- (void)makeCustomizeSheet {
    ...
    // Page 3 - Date Options
    customizeDate = [[LWWatchFaceCustomizations alloc] generalDateCustomize:CGRectMake(0, 0, 312, 390)
                                                           withTarget:self
...
- (void)renderIndicators:(BOOL)customize {
    ...
    [indicatorContainer addSubview:[[LWWatchFaceIndicators alloc] chronoIndicators]];
...
- (void)makeDateLabel {
    ...
    //[self insertSubview:dateLabel atIndex:0];
}
